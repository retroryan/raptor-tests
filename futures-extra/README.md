## Forked from Spotify Futures Extra

This is forked from:

https://github.com/spotify/futures-extra

I submitted a PR to allow for the executor to be passed to CompletableFuturesExtra#toCompletableFuture and until that is merged this library needs to be built locally.

I also removed the jar signing to make local builds easier, since this is not being pushed to mvn central.
